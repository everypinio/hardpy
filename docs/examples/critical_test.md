...
This is example of using the **critical** marker in **pytest-jig** to control test execution flow.

The [@pytest.mark.critical](./../documentation/pytest_jig.md#critical) 
