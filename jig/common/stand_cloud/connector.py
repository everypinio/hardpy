...
from jig.common.stand_cloud.exception import StandCloudError
from jig.common.stand_cloud.oauth2 import OAuth2
from jig.common.stand_cloud.token_manager import TokenManager
from jig.common.stand_cloud.utils import StandCloudAPIMode, StandCloudAddr
...
class StandCloudConnector:
    ...
    def __init__(
        ...
        api_mode: StandCloudAPIMode = StandCloudAPIMode.JIG,
        api_version: int = 1,
        ...
        self._client_id = "jig-report-uploader"
