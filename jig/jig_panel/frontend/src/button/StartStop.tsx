...
class StartStopButton extends React.Component<Props, State> {
  ...
  constructor(props: Props) {
    ...
    this.jig_start = this.jig_start.bind(this);
    this.jig_stop = this.jig_stop.bind(this);
  }
   ...
   * @private
   */
  private jig_call(uri: string): void {
  ...
  private readonly handleSpaceKey = (event: KeyboardEvent): void => {
    ...
    is_testing_in_progress ? this.jig_stop() : this.jig_start();
  };
