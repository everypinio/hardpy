...
from hardpy.cli.cli import run as run_panel
...
class ExampleCatalog:
    ...
    An example is a directory containing a `hardpy.toml` file.
    """
    ...
    def _is_example(self, example_dir: Path) -> bool:
        return (example_dir / "hardpy.toml").is_file()
...
def main(
    ...
    """Run the HardPy operator panel for an example.
